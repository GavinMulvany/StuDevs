						...
						<div class="dark-col margin-top-60">
							<div class="row">
								...
								<div class="col-xs-12 col-sm-6">
									<select name="prop type" class="bootstrap-select" title="Property type:">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 small-cont">
					<img src="images/logomela.jpg" alt="Mela" class="img-responsive footer-logo" id="navLogo" />
				</div>
				<div class="col-xs-12 col-md-6 footer-copyrights">
					&copy; Copyright Mela 2016<a href="http://mela.com.mt" target="blank"></a> | All Rights Reserved
				</div>
			</div>
		</div>
	</footer>
