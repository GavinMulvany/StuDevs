...
//AND THERE WAS A GO BACK AND A GO HOME FUNCTION SO ADD THESE BACK FROM ORIGINAL APARTMENT THEME
?>
<!--
    <section class="short-image no-padding blog-short-title">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-lg-12 short-image-title er404bak">
