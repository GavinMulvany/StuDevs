				...
				<div class="modal-body">
					...
					<div class="modal-title">
						...
						if(strpos($url, 'sign_up_error=empty_fields')!==false){
							...
							echo "Invalid Name";
							$errorDetails = 'At Mela we require your real name. Special characters such as \'%\' or \'€\' are not allowed.';
						}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					...
					<a href="http://www.mela.com.mt" class="button-primary button-shadow button-full">
