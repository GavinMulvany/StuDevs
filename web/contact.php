		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 margin-top-45">
					<p class="negative-margin">Mela.com.mt | Property Advertisement</p>
					<img id="contactImage" src="images/sunrisemaltaSmall.jpg" alt="" class="pull-left margin-top-45" />
					<address class="contact-info pull-left">
						<span><i class="fa fa-map-marker"></i>Sliema, Malta</span>
						<span><i class="fa fa-envelope"></i><a href="mailto:info@mela.com.mt">info@mela.com.mt</a></span>
						<span><i class="fa fa-phone"></i>77635277</span>
