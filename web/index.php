		...
		<div id="swiper1" class="swiper-container">
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="slide-bg swiper-lazy" data-background="images/sunrisemalta.jpg"></div>
					<!-- Preloader image -->
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-lg-3">
							<select name="city2" class="bootstrap-select" title="City:" multiple data-actions-box="true">
								...
								<option>Phsfdia</option>
								<option>Phstudevx</option>
								<option>Wstudevn</option>
				...
				<div class="col-sm-6 col-lg-4">
					<div class="feature wow fadeInUp" id="feature2">
						...
						<div class="feature-text">
							...
							<div class="title-separator center-block feature-separator"></div>
							<p>Resi dedsf dntial property is vias df f sd fksdjkfjds jks jj oi oas  s dafmnn snsm fnm msa fmin our listings.</p>
						</div>
					</div>
				</div>			
				<div class="col-sm-6 col-lg-4">
